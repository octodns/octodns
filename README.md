...
providers:
  ...
  route53:
    ...
    max_changes: 200  # if you don't pass in this value in config default value is 100. This is the solution to overcome the aws DNS Limitations http://docs.aws.amazon.com/Route53/latest/DeveloperGuide/DNSLimitations.html
